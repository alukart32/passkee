...
func (x *IndexObjectsResponse) GetNames() [][]byte {
	if x != nil {
		return x.Names
	}
	return nil
...
type DownloadObjectResponse_ObjectInfo struct {
	...
	Notes []byte `protobuf:"bytes,1,opt,name=notes,proto3,oneof" json:"notes,omitempty"`
}
...
type UpdateObjectInfoRequest_ObjectInfo struct {
	...
	Notes []byte `protobuf:"bytes,2,opt,name=notes,proto3,oneof" json:"notes,omitempty"`
}
...
var file_object_proto_rawDesc = []byte{
	...
	0x05, 0x6e, 0x6f, 0x74, 0x65, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0c, 0x48, 0x00, 0x52, 0x05,
	...
	0x20, 0x01, 0x28, 0x0c, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x12, 0x25, 0x0a, 0x03, 0x74, 0x79,
	...
	0x12, 0x17, 0x0a, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0c, 0x48, 0x00,
	0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x88, 0x01, 0x01, 0x12, 0x19, 0x0a, 0x05, 0x6e, 0x6f, 0x74,
	0x65, 0x73, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0c, 0x48, 0x01, 0x52, 0x05, 0x6e, 0x6f, 0x74, 0x65,
	...
	0x52, 0x03, 0x74, 0x79, 0x70, 0x22, 0x2c, 0x0a, 0x14, 0x49, 0x6e, 0x64, 0x65, 0x78, 0x4f, 0x62,
	0x6a, 0x65, 0x63, 0x74, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x14, 0x0a,
	0x05, 0x6e, 0x61, 0x6d, 0x65, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0c, 0x52, 0x05, 0x6e, 0x61,
	0x6d, 0x65, 0x73, 0x22, 0x50, 0x0a, 0x13, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x4f, 0x62, 0x6a,
	0x65, 0x63, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x12, 0x0a, 0x04, 0x6e, 0x61,
	0x6d, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x12, 0x25,
...
var file_object_proto_depIdxs = []int32{
	...
	0,  // 8: blob.v1.DeleteObjectRequest.typ:type_name -> blob.v1.ObjectType
	0,  // 9: blob.v1.UploadObjectRequest.ObjectInfo.typ:type_name -> blob.v1.ObjectType
	1,  // 10: blob.v1.BlobVault.UploadObject:input_type -> blob.v1.UploadObjectRequest
	3,  // 11: blob.v1.BlobVault.DownloadObject:input_type -> blob.v1.DownloadObjectRequest
	5,  // 12: blob.v1.BlobVault.UpdateObjectInfo:input_type -> blob.v1.UpdateObjectInfoRequest
	6,  // 13: blob.v1.BlobVault.IndexObjects:input_type -> blob.v1.IndexObjectsRequest
	8,  // 14: blob.v1.BlobVault.DeleteObject:input_type -> blob.v1.DeleteObjectRequest
	12, // 15: blob.v1.BlobVault.UploadObject:output_type -> google.protobuf.Empty
	4,  // 16: blob.v1.BlobVault.DownloadObject:output_type -> blob.v1.DownloadObjectResponse
	12, // 17: blob.v1.BlobVault.UpdateObjectInfo:output_type -> google.protobuf.Empty
	7,  // 18: blob.v1.BlobVault.IndexObjects:output_type -> blob.v1.IndexObjectsResponse
	12, // 19: blob.v1.BlobVault.DeleteObject:output_type -> google.protobuf.Empty
